...
The reading mode requires 100uA on pin 1 while the programming mode requires 50mA maximum. 
...
Byte 0 (A0 = V IL ) rep-resents the manufacturer code and byte 1 (A0 = V IH ) the device identifier code. 
